    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <shiro:hasAnyRoles name="经理,员工">
                ...
                <li class="${param.menu == 'sales' ? 'active':''}"><a href="/sales"><i class="fa fa-building-o"></i> <span>进度管理</span></a></li>
                <li class="${param.menu == 'customer' ? 'active':''}"><a href="/customer"><i class="fa fa-users"></i> <span>客户管理</span></a></li>
                <li class="${param.menu == 'chart' ? 'active':''}"><a href="chart"><i class="fa fa-line-chart"></i> <span>统计</span></a></li>
            ...
            <shiro:hasRole name="管理员">
                <li class="treeview">
                    <a href="javaScript:;"><i class="fa fa-gears"></i> <span>系统管理</span>
